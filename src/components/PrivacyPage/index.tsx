...
import {ContentWrapper, Title, TopTitle, TopTitleText, SimpleText, SimpleLink, Paragraph} from "../TermsPage/styles";
...
export const PrivacyPage: React.FC = () => {
  return (
    <>
      <Seo description={""} image={""} title={"Privacy"} />
      <MainContainer>
        <TopTitle>
          <TopTitleText>Privacy</TopTitleText>
        </TopTitle>
        <ContentWrapper>
